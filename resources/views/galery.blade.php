...
@section('container')
	...
	<div id="projects" class="filter">
		<div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">every journey has a story</div>
                    <h2>GALERY JUST A TRIP</h2>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="button-group filters-button-group">
                        ...
                        <a class="button" data-filter=".design"><span>Sailing Komodo</span></a>
                        <a class="button" data-filter=".development"><span>Road Trip Sumba</span></a>
                        <a class="button" data-filter=".marketing"><span>Overland Flores</span></a>
