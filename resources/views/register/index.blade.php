          ...
          <h1 class="h3 mb-3 fw-normal text-center">Registrasi Form</h1>
            <form action="/register" method="post">
              ...
              <div class="form-floating">
                ...
                <input type="email" name="email" class="form-control ronded-battom @error('email')is-invalid @enderror" id="email" placeholder="" required  value="{{ old('email') }}">   
              ...
              <div class="form-floating"> 
                ...
                <input type="password" name="password" class="form-control rounded-buttom @error('password')is-invalid @enderror" id="password" placeholder="" >
            ...
            <small class="d-block text-center mt-3"> <a href="/login-admin">login now</a></small>
          </main>
        </div>
